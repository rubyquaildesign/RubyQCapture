        ...
        this.start = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    ...
                    folder = process.env.HOME + "/.rubyqcapture";
                    folderExists = isDirSync(folder);
                    if (!folderExists)
                        fs_1.default.mkdirSync(folder);
                    console.log("folder: " + isDirSync(folder));
                    fs_1.default.readdirSync(folder).map(function (d) { return fs_1.default.unlinkSync(folder + '/' + d); });
                    this.started = true;
                    return [2 /*return*/];
                });
            });
