...
const startCommonOptions = z.object({
	...
	ulid: z.string().default(() => ulid()),
});
const pngURLOptions = startCommonOptions.extend({
	format: z.literal("pngUrl").default("pngUrl"),
});
const BufferOptions = startCommonOptions.extend({
...
export type ResponseMessage = z.infer<typeof errorMessage> | z.infer<typeof readyMessage>